...
@EnableJpaRepositories(
        basePackages = "com.stc.client.repository",
...
public class MysqlJpaConfig {
    ...
    @Autowired
    public MysqlJpaConfig(@Qualifier("mysqlDatasource") DataSource  mysqlDatasource){
    ...
    public EntityManagerFactory builEntityMangerMysql(){
        ...
        locaContainer.setPackagesToScan("com.stc.client.model");
